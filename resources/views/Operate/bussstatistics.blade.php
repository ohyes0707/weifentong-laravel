...
<!--					    <select name="parentid" class="form-control">
					    	<option value="">全部</option>
                                            @if($bussname!=null)
                                                @foreach ($bussname as $key => $datalist)    
                                                    <option value="{{$datalist['parent_id']}}">{{$datalist['username']}}</option>
                                                @endforeach
                                            @endif    
					    </select>-->
				...
				@foreach ($paginator as $key => $datalist)
					<tr class="f_channel off_channel" channelId="{{ $key }}">
						...
						<td>
                                                    <a href="getBussDetail?parentid={{$datalist['parent_id']}}&startdate={{ $termarray['startdate'] }}&enddate={{ $termarray['enddate'] }}&usertype={{ $termarray['usertype'] }}" class="option_detail">查看公众号</a>
                                                    <a href="getBussOneReport?parentid={{$datalist['parent_id']}}&startdate={{ $termarray['startdate'] }}&enddate={{ $termarray['enddate'] }}&usertype={{ $termarray['usertype'] }}" class="option_detail">查看子渠道</a>
                                                </td>
					</tr>
...
//		        startDate:new Date()
		    ...
		    $('.find').click(function(){
                    ...
                    $('.excel').click(function(){
                        $('.form-inline').attr("action", 'getBussReportExcel').submit();
                    }) 
                    $("#datetimeStart").val("{{ $termarray['startdate'] }}");
                    $("#datetimeEnd").val("{{ $termarray['enddate'] }}");
