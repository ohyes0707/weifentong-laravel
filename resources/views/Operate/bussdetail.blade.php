...
<!--					    <select name="wxid" class="form-control">
					    	<option value="">全部</option>
                                            ...
                                            <input type="text" id="inputv" onkeyup="checkFunction()" name="wxName"  class="form-control" autocomplete="off" value="">
                                                    <ul id="ul_hide">
                                                        @if(isset($paginator))
                                                            @foreach ($paginator as $key => $datalist)    
			...
			$('table').delegate('.f_channel','click',function(){
				...
				if($sub.length>0){
                    ...
                    $(".reset").click(function () {
                            window.location.href = 'getBussDetail?parentid={{$termarray['parentid']}}';
                    })
		})
	</script>
</html>
