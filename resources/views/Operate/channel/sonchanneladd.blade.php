	...
	<body>
		...
		<div class="main clearfix">
			...
			<div class="main-right">
				<div class="header">新增子渠道</div>
				
				<form action="" method="post" class="form">
                                        <div class="form-list">
						<label>所属父渠道：</label><span>{{$username}}</span>
					</div>
					<div class="form-list">
						<label>账号：</label><input type="input" name="account" placeholder="账号" class="text-input must-input" id="account"/>
					...
					<div class="myalert" style="display: none;">
						...
						<div class="alertbox">
							...
							<div class="alertbtn">
                                                                <input type="text" name="status" value="{{$bussiness['status']}}" hidden=""/>
                                                                <input type="text" name="pbid" value="{{$id}}" hidden=""/>
