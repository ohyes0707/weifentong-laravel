		...
		<div class="main clearfix">
			...
			<div class="main-right">
				...
				<form action="" method="post" class="form">
					...
					<div class="form-list">
						<label>结算一口价：</label><input type="input" name="price" class="text-input" value="{{$bussiness['cost_price']}}"/>
					</div>
					<div class="form-list">
                                                        ...
                                                        <div class="text-input">
                                                            <div class="chosen-show clearfix">
                                                                        ...
                                                                        <div class="city-chosen">
                                                                                <input name="tags" id="tags" value="{{$bussinfo['buss_area']}}" />
                                                                        </div>
                                                                </div>
                                                                <div class="choose">
                                                            ...
                                                            <input type="text" name="hot_area"  value="{{ $bussinfo['buss_area'] }}" id="hot_area" style="display: none"/>
