...
<html>
	<head>
		<meta charset="utf-8" />
		<title>优粉通-运营系统-登录</title>
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('operate/css/common.css') }}"/>
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('operate/css/index.css') }}"/>
		<script src="{{ URL::asset('js/jquery-2.1.4.min.js') }}" type="text/javascript" charset="utf-8"></script>
		<script src="{{ URL::asset('operate/js/function.js') }}" type="text/javascript" charset="utf-8"></script>
	</head>
	<body>
		<div class="nav"></div>
		<div class="main">
			<div class="logo">
				<a href="javascript: void(0);"><img src="{{ URL::asset('operate/img/logo.png') }}"/></a>
			</div>
			<div class="content clfix">
				<div class="con-left">
					<img src="{{ URL::asset('operate/img/login_pic.png') }}"/>
					<p>微信公众号专业涨粉交易平台</p>
				</div>
				<div class="con-right">
					<div class="login">
						<div class="login-logo"><img src="{{ URL::asset('operate/img/logo.png') }}"/></div>
						<h3 class="head">账号登录</h3>
        ...
        <script type="text/javascript">
            ...
            function doLogin(){
                $.post("{{action('Operate\UserController@doLogin')}}",$(".user_login").serialize(),function(res){
                    $(".note_captcha").hide();
                    $(".note_username").hide();
                    $(".note_password").hide();
                    if(res.code!=1000){
