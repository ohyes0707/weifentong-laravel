...
<html>
	<head>
		<meta charset="utf-8" />
		<title>优粉通-用户系统-登录</title>
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('home/css/common.css') }}"/>
	...
	<body>
		...
		<div class="main">
			<div class="logo">
				<a href="javascript: void(0);"><img src="{{ URL::asset('home/img/logo.png') }}"/></a>
			</div>
			<div class="content clfix">
				<div class="con-left">
					<img src="{{ URL::asset('home/img/login_pic.png') }}"/>
					<p>微信公众号专业涨粉交易平台</p>
				</div>
				<div class="con-right">
					<div class="login">
						<div class="login-logo"><img src="{{ URL::asset('home/img/logo.png') }}"/></div>
    ...
    <script type="text/javascript">
        ...
        function doLogin(){
            ...
            $.post("{{action('Home\UserController@doLogin')}}",$(".user_login").serialize(),function(res){
                $(".note_captcha").hide();
                $(".note_username").hide();
                $(".note_password").hide();
                if(res.code!=1000){
