...
class ReportController extends Controller
{
    ...
    public function reportList(){
        ...
        return view('Home.report_list',['reportlist'=>$reportlist_arr,'paginator'=>$paginator,'wxlist'=>$wxlist_arr,'post'=>$_REQUEST]);
    }
    ...
    public function editReport(){
        ...
        if($id&&$userid){
            ...
            return view('Home.edit_report', ['report'=>$report]);
        }
        die("缺少参数");
    }
...
/*            if($data['success']&&!empty($data['data'])&&isset($id)){
 ...
 // 发起授权
    public function addAuth(){
        ...
        header('Location: http://'.$api_url.'Wechat/auth_redirect?rid='.$rid.'&url='.$url);
    }
