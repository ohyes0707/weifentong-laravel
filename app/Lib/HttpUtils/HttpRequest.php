...
//    const SERVICE_URL = 'http://api.wft.com/'; // 域名
    const SERVICE_URL = 'api.youfentong.com/';
     ...
     * @return httpData
     */
    static public function getApiServices($models, $function, $method, $parameter=null)
    {
        $httpData = null;
        ...
        $url = self::SERVICE_URL . $models . '/' . $function . '/' . self::VERSION;
        $request = array();
